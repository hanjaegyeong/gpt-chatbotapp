...
class HomeFragment : Fragment(R.layout.fragment_home) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        button1.setOnClickListener {
            ...
            intent.putExtra("prompt", "너는 질문에 반드시 \"예\", \"아니오\", \"정답입니다.\", \"제대로 된 질문을 해주십시오\"로만 말해. " +
                    "사용자가 정답을 맞히면 \"정답입니다\"라고 하고, 부분적으로 맞히면 \"예\", 틀리면 \"아니오\"라고 답해.\n" +
                    "정답은 시각장애를 가지고 있던 A는 모두의 팔 한 짝씩을 잘라서 음식을 만들었다는 B와 C의 말을 믿고 음식을 먹으며 버텼는데 A는 B와 C의 박수 소리가 들려서 살해를 했다.\n" +
